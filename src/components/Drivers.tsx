...
export function Drivers() {
  const benefits = [
    { icon: ShieldAlert, text: 'Mais segurança e suporte' },
    { icon: DollarSign, text: 'Comissão justa e transparente' },
    { icon: BookOpen, text: 'Orientações e treinamentos' },
    { icon: Users, text: 'Fortalecimento da categoria' },
    { icon: Handshake, text: 'Participação e união entre motoristas' },
  ];

  return (
    <section id="motoristas" className="py-20 bg-white">
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-12">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold text-brand-navy mb-4">
              Para <span className="text-brand-navy">Motoristas</span>
            </h2>
            <p className="text-xl text-gray-600 mb-8 font-medium">
              Faça parte de uma cooperativa que valoriza você.
            </p>

            <ul className="space-y-4 mb-10">
              {benefits.map((benefit, index) => (
                <li key={index} className="flex items-center gap-4 bg-gray-50 p-4 rounded-xl border border-gray-100 transition-colors hover:bg-gray-100">
                  <div className="bg-brand-navy/10 p-2 rounded-full text-brand-navy shrink-0">
